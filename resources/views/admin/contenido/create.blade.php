                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Contenidos Crear</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <strong>Contenidos</strong> Crear
                    </div>
                    <div class="card-body card-block">
                        {!! Form::open(['route' => 'contenidos.store', 'method' => 'POST', 'files' => 'true' , 'class' => 'form-horizontal']) !!}                               
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    {!! Form::file('imagen', ['class' => 'form-control-file' , 'placeholder' => 'Nombre del Contenido.' , 'required' => 'required']) !!}
                                    <small class="form-text text-muted">Requerido.</small>
                                </div>
                            </div>
