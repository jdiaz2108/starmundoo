                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Imagenes Editar</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <strong>Imagenes</strong> Editar
                    </div>
                    <div class="card-body card-block">
                        {!! Form::model($imagen, ['route' => ['imagenes.update', $imagen], 'method' => 'PUT', 'files' => 'true' , 'class' => 'form-horizontal form-label-left']) !!}                                
